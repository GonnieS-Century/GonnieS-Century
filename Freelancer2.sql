...
-- filling in null and blank values with the minimum possible values, in this case being 18 as is the legal age eligible for work
...
-- filling null values with proper values for future data collection and correction